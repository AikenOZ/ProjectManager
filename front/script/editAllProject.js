$(document).ready(function() {
    ...
    $.ajax({
        url: 'http://127.0.0.1:8000/allProject',
        type: 'GET',
                ...
                let card = `
                    <div class="card mb-3" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <a href="editotUpdateProject.html?id=${project.id}" class="btn btn-danger">Изменить</a>
    ...
    function deleteTask() {
        ...
        if (confirm('Вы уверены, что хотите удалить этот проект?')) {
            $.ajax({
                url: `http://127.0.0.1:8000/project/${projectId}`, // Убедитесь, что URL правильный
                type: 'DELETE',
                dataType: 'json',
                success: function() {
