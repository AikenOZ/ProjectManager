$(document).ready(function () {
    ...
    function fetchTasks(priority = '') {
        $.ajax({
            url: `http://127.0.0.1:8000/projects/${projectId}/tasks`,
            type: 'GET',
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-footer">
                                    <a href="editorUpdateTask.html?id=${task.id}" class="btn btn-danger">Изменить</a>
    ...
    $('#tasks-container').on('click', '.delete-task', function () {
        ...
        if (confirm('Вы уверены, что хотите удалить эту задачу?')) {
            $.ajax({
                url: `http://127.0.0.1:8000/task/${taskId}`,
                type: 'DELETE',
                dataType: 'json',
                success: function () {
