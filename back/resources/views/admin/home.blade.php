                ...
                <tbody> 
                    @foreach($users as $key => $user)   
                        <tr> 
                            ...
                            <td> 
                            <a href="{{ route('adminUpdateUser', $user->id) }}"> <button type="button" class="btn btn-danger">Редактировать</button> </a>
                               <!-- <a href=""> <button type="button" class="btn btn-danger">Редактировать</button> </a> -->
